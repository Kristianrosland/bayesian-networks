...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/*
This file was created by editing the constraint handler template file
in SCIP
*/
...
)
{
   ...
   /* SCIP_CALL( SCIPsetRealParam(auxipdata->subscip, "limits/time",3.0 ) );*/
   ...
   */
   ...
   for (s = 0; s <  nsols; ++s)
   {
    ...
    if( n_included < consdata->nParentSets[i] )
...
/** frees constraint handler data for dagcluster constraint handler */
/* static */
